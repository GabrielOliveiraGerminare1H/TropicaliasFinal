...
public class Usuario {
    ...
    String userName;
    Date dt_nascimento;
    String descricaoUsua;
    Long cpf;
    String nome;
    int fk_int_id_endereco;

    public Usuario(String textFoto, String varEmail, String senha, String userName, Date dt_nascimento, String descricaoUsua,
                   Long cpf, String nome, int fk_int_id_endereco) {
