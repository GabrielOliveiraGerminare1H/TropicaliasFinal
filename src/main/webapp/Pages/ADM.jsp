...
<div class="container"> <!-- Container principal da página -->
    <div class="menuCima"> <!-- Menu superior -->
        <div class="opcaoEvento"> <!-- Seção para opções de eventos -->
            ...
            <h1>Evento</h1>
            <!-- Links que redirecionam para as pages .jsp de cada função dos botões de evento -->
            <ul>
        ...
        <div class="opcaoMascote"> <!-- Seção para opções de mascote -->
            <img src="../Assets/cores.png" alt=""> <!-- Ícone de cores -->
            <h1>Mascote</h1>
            <!-- Links que redirecionam para as pages .jsp de cada função dos botões de mascote -->
            <ul>
    ...
    <div class="menuBaixo"> <!-- Menu inferior -->
        <div class="opcaoAnuncio"> <!-- Seção para opções de anúncios -->
            <img src="../Assets/anuncios.png" alt=""> <!-- Ícone de anúncios -->
            <h1>Anúncios</h1>
            <!-- Links que redirecionam para as pages .jsp de cada função dos botões de anúncio-->
            <ul>
        ...
        <div class="opcaoUsuario"> <!-- Seção para opções de usuários -->
            <img src="../Assets/user.png" alt=""> <!-- Ícone de usuários -->
            <h1>Usuários</h1>
            <!-- Links que redirecionam para as pages .jsp de cada função dos botões de usuário -->
            <ul>
        ...
        <div class="opcaoBarraca"> <!-- Seção para opções de barracas -->
            <img src="../Assets/barraca.png" alt=""> <!-- Ícone de barracas -->
            <h1>Barraca</h1>
            <!-- Links que redirecionam para as pages .jsp de cada função dos botões de barraca -->
            <ul>
