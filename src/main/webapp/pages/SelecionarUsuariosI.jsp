...
<head>
    <meta charset="UTF-8">
    <title id="selecionarUsuarioI">Usuários</title>
    <style>
...
font-family: Oswald, sans-serif;" id="selecionarUsuariosI">LISTA DE USUÁRIOS INATIVOS</h2> <%-- Título principal da página, estilizado --%>
